...
// Storage key formerly exported by `contrib/agentsVoice` (removed from core along with the
// rest of the bundled agent stack). Inlined here to keep the value stable for existing users.
